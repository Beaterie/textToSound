...
//		    }
		...
		TextLexProcessor processor1 = new TextLexProcessor("data/lit/The-Wolf-and-the-Seven-Kids.txt", "data/lexicon_animals.csv");
		...
		NEREmotionProcessor NERprocessor1 = new NEREmotionProcessor("data/lit/The-Wolf-and-the-Seven-Kids.txt", mp.getM_numOfSections());
